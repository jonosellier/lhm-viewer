import{s as l,e as n,c as i,l as u,m as h,i as d,n as a,f as c}from"../chunks/scheduler.D0mmhpNY.js";import{S as m,i as p}from"../chunks/index.DTMTwjKP.js";import{b as y}from"../chunks/paths.Bv69C8gR.js";function f(o){let e,s=`<h1 class="text-6xl mb-20 font-bold">ChartMyRig</h1> <div class="p-8 rounded-xl border border-slate-500 bg-slate-800 max-w-3xl w-max"><h1 class="text-4xl pb-3">Get Started</h1> <ol class="list-decimal marker:text-orange-500 text-2xl ps-8"><li class="my-5">Using Libre Hardware Monitor, select <strong>Options</strong> in the menu bar and make sure
				...
				Once the chart has been uploaded and shared, just send the link to anyone.</li></ol></div>`;return{c(){e=n("div"),e.innerHTML=s,this.h()},l(t){e=i(t,"DIV",{class:!0,"data-svelte-h":!0}),u(e)!=="svelte-1y8m2pj"&&(e.innerHTML=s),this.h()},h(){h(e,"class","flex w-full h-full items-center justify-center flex-col")},m(t,r){d(t,e,r)},p:a,i:a,o:a,d(t){t&&c(e)}}}class x extends m{constructor(e){super(),p(this,e,null,f,l,{})}}export{x as component};
